/*
 * Modified by Neurwerk, 2025-2026: integrate the Keycloak SSO sign-in flow.
...
function NormalForm() {
  ...
  // Show SSO redirect page instead of login form when Keycloak is the only auth method
  if (hasSocialLogin && !searchParams.get('method') && !isInviteLink) {
    return <SsoRedirect />
  }
